                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <?php if (!empty($sanPham['hinh_anh'])): ?>
                                    <div>
                                        <img src="<?= BASE_URL . $sanPham['hinh_anh'] ?>" alt="Ảnh cũ" style="width: 100px; height: auto; margin-bottom: 10px;">
                                    </div>
                                <?php endif; ?>
...
<script>
    ...
    function addfaqs() {
        ...
        html += '<td><img src="https://giayxshop.vn/wp-content/uploads/2023/11/z5490803329093_c996ec50b6b04958fdbc984bb3209c2b.jpg" style="width:50px; height: 50px;" alt=""></td>';
